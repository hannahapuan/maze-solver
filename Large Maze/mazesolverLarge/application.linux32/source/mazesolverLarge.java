...
public class mazesolverLarge extends PApplet {
...
public void VSpaceSetup(int[] VSpace, int x, int y) { 
  g ++; 
  VSpace[y*width+x] = 1; 
  ...
  while (count > 0) { 
    switch (PApplet.parseInt(random(1)*4)) { 
    case 0: 
...
public int isValid(int[] VSpace, int x, int y) { 
  ...
  public void settings() {  size(294, 294); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "mazesolverLarge" };
    if (passedArgs != null) {
